import { V as setContext, X as sanitize_slots, Y as fallback, Z as attr, _ as slot, $ as bind_props, W as pop, a0 as sanitize_props, T as push, a1 as stringify, a2 as rest_props, a3 as spread_attributes, a4 as getContext, a5 as clsx, a6 as add_styles, a7 as store_get, a8 as escape_html, a9 as unsubscribe_stores, aa as head, ab as ensure_array_like } from "../../chunks/index.js";
...
import { y as yayState, g as get_model_sidecar_ready } from "../../chunks/state.svelte.js";
    ...
    children: ($$payload2) => {
      if (store_get($$store_subs ??= {}, "$drawerStore", drawerStore).id === "rule-drawer") {
        ...
        CodeBlock($$payload2, {
          lineNumbers: "true",
          language: "yara",
          code: rule_src(store_get($$store_subs ??= {}, "$drawerStore", drawerStore).meta.identifier)
        });
        $$payload2.out += `<!----></div>`;
      } else {
        $$payload2.out += "<!--[!-->";
      ...
      sidebarLeft: ($$payload2) => {
        {
          AppRail($$payload2, {
            children: ($$payload3) => {
              ...
              AppRailAnchor($$payload3, {
                href: "/detect",
                selected: store_get($$store_subs ??= {}, "$page", page).url.pathname === "/detect",
                children: ($$payload4) => {
                  $$payload4.out += `<!---->${escape_html(console.log(yayState.model_sidecar_ready))} `;
                  if (get_model_sidecar_ready()) {
                    $$payload4.out += "<!--[-->";
                    $$payload4.out += `ML`;
                  } else {
                    $$payload4.out += "<!--[!-->";
                    $$payload4.out += `<div class="flex justify-center items-center">`;
                    ProgressRadial($$payload4, { width: "w-8" });
                    $$payload4.out += `<!----></div>`;
                  }
                  $$payload4.out += `<!--]-->`;
                },
